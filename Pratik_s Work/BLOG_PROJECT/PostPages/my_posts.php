...
<body>
    <div class="navbar">
        <ul>
            ...
            <li class="texti"><a href="../helper/logout.php">Logout</a></li>
    ...
    <div class="wrapper">
        ...
        <div class="main_content">
            <?php foreach ($query as $q) {
                ...
                if ($q['type'] == "Blog" and $q['userID'] == $_SESSION['id']) { ?>
                    ...
                    <div class="post blog">
                        <div class="row" style="margin:0;">
                            ...
                            <form method="GET">
                                <input type="text" name="postid" value="<?php echo $q["id"]; ?>" hidden>
                        ...
                        <div class="profile_info">
                            ...
                            <div class="row postcat">
                                ...
                                <a href="../CommentPage/comments_page.php?commentid=<?php echo $q['id']; ?>"><i class="fas fa-comment chat">
