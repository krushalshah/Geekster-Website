        ...
        <form method="GET">
            <?php foreach ($posts as $p) { ?>
                <div class="container add">
                    ...
                    <?php } ?>
                    <br><br>
                    <input id="hashtag" type="text" size="53" class="title" placeholder="Hash Tags" name="hashtag" value = <?php echo $p['hashtags'];?> required>
                    ...
                    <br><br>
                    <button name="updatepost" class="submitpost">Update POST</button>
                <?php } ?>
        </form>
