 <?php
    ...
    if (isset($_REQUEST["submitpost"])) {
        ...
        $sql = "INSERT INTO newblogs(userID, title, description, type, hashtag, commentsCount, pictureUrl) VALUES($userID,'$title','$description','$type','$hashtag',$commentsCount, '$url')";
