    ...
    if (strlen ($u) < 5){
      ...
      $mysqli = NEW MySQLi ('localhost','root','','dbms_project') or die ("Unable to connect to the server");
       ...
       //SANITIZE FROM DATA
        ...
        $p = md5($p);
        //echo $p;
        $insert ="INSERT INTO accounts(username,password_,email,vkey) VALUES ('$u','$p','$e','$vkey')";
        ...
        if($insert){
            ...
            $message = "<a href='http://localhost/DBMS_PROJECT_WORKSPACE/FIRST_ITTERATION/verify.php?vkey=$vkey' > Register Account </a> ";
