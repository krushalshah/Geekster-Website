        ...
        <div class="main_content" style="margin-left: 300px;">
            ...
            <?php if (isset($_REQUEST['searchSubmit']) and $_REQUEST['searchSubmit'] != "") { ?>
                <?php foreach ($profiles as $p) { ?>
                    <div class="row" style="margin-bottom: 0;">
                        <img src=<?php if ($p['profileUrl'] != NULL) { ?> <?php echo $p['profileUrl'];
                                                                        } else { ?><?php echo "..\images\default.png";
                                                                                } ?> alt="" height="50px" width="50px">
                        <div class="col-md-5">
                        ...
                        <a href="../../../GauriWork/profile.php?searchid=<?php echo $p['id']; ?>">
            ...
            <?php } else { ?>
                <?php foreach ($query as $q) { ?>
                    <div class="row" style="margin-bottom: 0;">
                        <img src=<?php if ($q['profileUrl'] != NULL) { ?> <?php echo $q['profileUrl'];
                                                                        } else { ?><?php echo "..\images\default.png";
                                                                                } ?> alt="" height="50px" width="50px">
                        <div class="col-md-5">
                        ...
                        <a href="../../../GauriWork/profile.php?searchid=<?php echo $q['id']; ?>">
                            <div class="viewprofile">
                                <h5>View Profile</h5>
                            </div>
                        </a>
